...
*/
#define WM_NAME "securityPanel"
#define WM_PASSWORD "password"

//Update service set up
String host = "securityPanel";
...
// Push notifications
const String NOTIFICATION_APP =  "pushoverApp";
const String NOTIFICATION_USER = "pushoverUser";  // This can be a group or user
